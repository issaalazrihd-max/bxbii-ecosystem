...
"ic-design-fundamentals":{price:79,currency:"OMR",level:"Foundation",arLevel:"تأسيسي",outcomes:["Understand the IC design flow","Connect RTL to verification","Understand tape-out stages"],arOutcomes:["فهم دورة تصميم الدوائر المتكاملة","ربط RTL بالتحقق","فهم مراحل الوصول إلى التصنيع"],lessons:[
...
"digital-design-and-rtl":{price:69,currency:"OMR",level:"Intermediate",arLevel:"متوسط",outcomes:["Write structured RTL","Understand synchronous design","Prepare RTL for verification"],arOutcomes:["كتابة RTL منظم","فهم التصميم المتزامن","تهيئة RTL للتحقق"],lessons:[
...
"advanced-packaging-and-chiplets":{price:99,currency:"OMR",level:"Advanced",arLevel:"متقدم",outcomes:["Understand chiplet architectures","Compare 2.5D and 3D integration","Evaluate interconnect trade-offs"],arOutcomes:["فهم معماريات Chiplet","مقارنة التكامل 2.5D و3D","تقييم مفاضلات الربط البيني"],lessons:[
...
"semiconductor-assembly-test-reliability":{price:89,currency:"OMR",level:"Intermediate",arLevel:"متوسط",outcomes:["Understand assembly and test stages","Map quality checkpoints","Explain reliability screening"],arOutcomes:["فهم مراحل التجميع والاختبار","تحديد نقاط الجودة","شرح فحوصات الموثوقية"],lessons:[
