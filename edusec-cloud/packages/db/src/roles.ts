 ...
 * implements (Branches, Students + transfer workflow, CMS/Navigation/Programs/Contact/Partners). As Phase 4+ modules
...
export const ROLE_TEMPLATES: Array<{
...
}> = [
  {
    ...
    permissions: ["dashboard.view", "branches.list", "branches.create", "students.list", "students.view", "students.create", "students.transfer.request", "students.transfer.review", "students.transfer.approve", "cms.pages.view", "cms.pages.create", "cms.pages.update", "cms.pages.delete", "cms.navigation.view", "cms.navigation.manage", "cms.programs.view", "cms.programs.manage", "cms.contact.view", "cms.contact.manage", "cms.partners.view", "cms.partners.manage"],
  },
  {
    code: "PLATFORM_ADMIN",
    ...
    permissions: ["cms.pages.view", "cms.pages.create", "cms.pages.update", "cms.pages.delete", "cms.navigation.view", "cms.navigation.manage", "cms.programs.view", "cms.programs.manage", "cms.contact.view", "cms.contact.manage", "cms.partners.view", "cms.partners.manage"],
  },
  {
  ...
  },
  {
    ...
    permissions: ["dashboard.view", "branches.list", "students.list", "students.view", "students.transfer.review", "cms.programs.view", "cms.programs.manage", "cms.contact.view", "cms.contact.manage", "cms.partners.view", "cms.partners.manage"],
  },
  {
